...
* so started working on signal processing in communications
* did a pair of USRAs
...
* statistical tests for the detection of signals (x2)
* time series clustering
* statistical structure of time series regression models

with another 3 Masters students ongoing, and 2 PhDs (one starting
January, with Theresa!)
